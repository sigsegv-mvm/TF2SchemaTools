...
class CMsgWebAPIRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  static const ::std::string _default_unused_job_name_;
  ::std::string* interface_name_;
  static const ::std::string _default_interface_name_;
...
class CMsgGCGetCommandList : public ::google::protobuf::Message {
 ...
 private:
  ...
  static const ::std::string _default_command_prefix_;
  friend void  protobuf_AddDesc_steammessages_2eproto();
  friend void protobuf_AssignDesc_steammessages_2eproto();
  friend void protobuf_ShutdownFile_steammessages_2eproto();
...
class CMsgAMAddFreeLicense : public ::google::protobuf::Message {
 ...
 private:
  ...
  static const ::std::string _default_store_country_code_;
  friend void  protobuf_AddDesc_steammessages_2eproto();
  friend void protobuf_AssignDesc_steammessages_2eproto();
  friend void protobuf_ShutdownFile_steammessages_2eproto();
...
class CGCMsgSystemStatsSchema : public ::google::protobuf::Message {
 ...
 private:
  ...
  static const ::std::string _default_schema_kv_;
  friend void  protobuf_AddDesc_steammessages_2eproto();
  friend void protobuf_AssignDesc_steammessages_2eproto();
  friend void protobuf_ShutdownFile_steammessages_2eproto();
...
class CGCMsgGetSystemStatsResponse : public ::google::protobuf::Message {
 ...
 private:
  ...
  static const ::std::string _default_stats_kv_;
...
class CMsgAMSendEmail_ReplacementToken : public ::google::protobuf::Message {
 ...
 private:
  ...
  static const ::std::string _default_token_name_;
  ::std::string* token_value_;
  static const ::std::string _default_token_value_;
  friend void  protobuf_AddDesc_steammessages_2eproto();
  friend void protobuf_AssignDesc_steammessages_2eproto();
  friend void protobuf_ShutdownFile_steammessages_2eproto();
...
class CMsgGCCheckClanMembership : public ::google::protobuf::Message {
 public:
  ...
  CMsgGCCheckClanMembership* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CMsgGCCheckClanMembership* default_instance_;
};
// -------------------------------------------------------------------

class CMsgGCCheckClanMembership_Response : public ::google::protobuf::Message {
 public:
  ...
  CMsgGCCheckClanMembership_Response* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline bool has_ismember() const;
  inline void clear_ismember();
  static const int kIsmemberFieldNumber = 1;
  inline bool ismember() const;
  inline void set_ismember(bool value);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CMsgGCCheckClanMembership_Response* default_instance_;
};
// -------------------------------------------------------------------
...
class CMsgGCMsgMasterSetDirectory_SubGC : public ::google::protobuf::Message {
 ...
 private:
  ...
  static const ::std::string _default_name_;
  ::std::string* box_;
  static const ::std::string _default_box_;
  ::std::string* command_line_;
  static const ::std::string _default_command_line_;
  ::std::string* gc_binary_;
  static const ::std::string _default_gc_binary_;
  friend void  protobuf_AddDesc_steammessages_2eproto();
  friend void protobuf_AssignDesc_steammessages_2eproto();
  friend void protobuf_ShutdownFile_steammessages_2eproto();
...
class CMsgGCHAccountTradeBanStatusChange : public ::google::protobuf::Message {
 public:
  ...
  CMsgGCHAccountTradeBanStatusChange* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline bool has_time_banned_until() const;
  inline void clear_time_banned_until();
  static const int kTimeBannedUntilFieldNumber = 4;
  inline ::google::protobuf::uint32 time_banned_until() const;
  inline void set_time_banned_until(::google::protobuf::uint32 value);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CMsgGCHAccountTradeBanStatusChange* default_instance_;
};
// -------------------------------------------------------------------

class CMsgGCHAccountLockStatusChange : public ::google::protobuf::Message {
 public:
  ...
  CMsgGCHAccountLockStatusChange* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CMsgGCHAccountLockStatusChange* default_instance_;
};
// -------------------------------------------------------------------
...
class CMsgGCHAccountTwoFactorChange : public ::google::protobuf::Message {
 public:
  ...
  CMsgGCHAccountTwoFactorChange* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline bool has_twofactor_enabled() const;
  inline void clear_twofactor_enabled();
  static const int kTwofactorEnabledFieldNumber = 3;
  inline bool twofactor_enabled() const;
  inline void set_twofactor_enabled(bool value);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CMsgGCHAccountTwoFactorChange* default_instance_;
};
// -------------------------------------------------------------------
...
class CMsgGCRoutingInfo : public ::google::protobuf::Message {
 ...
 private:
  ...
  static const ::std::string _default_webapi_param_;
  friend void  protobuf_AddDesc_steammessages_2eproto();
  friend void protobuf_AssignDesc_steammessages_2eproto();
  friend void protobuf_ShutdownFile_steammessages_2eproto();
...
class CMsgGCMsgSetOptions : public ::google::protobuf::Message {
 public:
  ...
  static const GCSQLVersion GCSQL_VERSION_BASELINE = CMsgGCMsgSetOptions_GCSQLVersion_GCSQL_VERSION_BASELINE;
  static const GCSQLVersion GCSQL_VERSION_BOOLTYPE = CMsgGCMsgSetOptions_GCSQLVersion_GCSQL_VERSION_BOOLTYPE;
  ...
  inline bool has_gcsql_version() const;
  inline void clear_gcsql_version();
  static const int kGcsqlVersionFieldNumber = 3;
  inline ::CMsgGCMsgSetOptions_GCSQLVersion gcsql_version() const;
  inline void set_gcsql_version(::CMsgGCMsgSetOptions_GCSQLVersion value);
...
inline void CMsgProtoBufHeader::set_gc_msg_src(GCProtoBufMsgSrc value) {
  GOOGLE_DCHECK(GCProtoBufMsgSrc_IsValid(value));
  _set_bit(8);
  gc_msg_src_ = value;
}
...
inline void CMsgWebAPIRequest::clear_unused_job_name() {
  if (unused_job_name_ != &_default_unused_job_name_) {
...
inline void CMsgWebAPIRequest::clear_interface_name() {
  if (interface_name_ != &_default_interface_name_) {
...
inline void CMsgGCGetCommandList::clear_command_prefix() {
  if (command_prefix_ != &_default_command_prefix_) {
...
inline void CMsgAMAddFreeLicense::clear_store_country_code() {
  if (store_country_code_ != &_default_store_country_code_) {
...
inline void CGCMsgSystemStatsSchema::clear_schema_kv() {
  if (schema_kv_ != &_default_schema_kv_) {
    schema_kv_->clear();
  }
  _clear_bit(1);
}
...
inline void CGCMsgGetSystemStatsResponse::clear_stats_kv() {
  if (stats_kv_ != &_default_stats_kv_) {
    stats_kv_->clear();
  }
  _clear_bit(1);
}
...
inline void CMsgAMSendEmail_ReplacementToken::clear_token_name() {
  if (token_name_ != &_default_token_name_) {
    token_name_->clear();
  }
  _clear_bit(0);
}
...
inline void CMsgAMSendEmail_ReplacementToken::clear_token_value() {
  if (token_value_ != &_default_token_value_) {
    token_value_->clear();
  }
  _clear_bit(1);
}
...
inline void CMsgGCMsgMasterSetDirectory_SubGC::clear_gc_binary() {
  if (gc_binary_ != &_default_gc_binary_) {
    gc_binary_->clear();
  }
  _clear_bit(4);
}
...
inline void CMsgGCRoutingInfo::set_method(::CMsgGCRoutingInfo_RoutingMethod value) {
  GOOGLE_DCHECK(::CMsgGCRoutingInfo_RoutingMethod_IsValid(value));
  _set_bit(1);
  method_ = value;
}
...
inline void CMsgGCRoutingInfo::clear_webapi_param() {
  if (webapi_param_ != &_default_webapi_param_) {
    webapi_param_->clear();
  }
  _clear_bit(4);
}
...
inline void CMsgGCMsgSetOptions::set_options(int index, ::CMsgGCMsgSetOptions_Option value) {
  GOOGLE_DCHECK(::CMsgGCMsgSetOptions_Option_IsValid(value));
...
inline void CMsgGCMsgSetOptions::set_gcsql_version(::CMsgGCMsgSetOptions_GCSQLVersion value) {
  GOOGLE_DCHECK(::CMsgGCMsgSetOptions_GCSQLVersion_IsValid(value));
  _set_bit(2);
